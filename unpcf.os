...
Перем ПутьИстории, КаталогИсходников;
...
procedure Инициализация()
	...
	ФайлМенеджерСинхронизации = Новый Файл(ОбъединитьПути(dev_Catalog, "МенеджерСинхронизации.os"));
	...
	ФайлRunner = Новый Файл(ОбъединитьПути(dev_Catalog, "Runner.os"));
