...
Процедура ОбработатьКаталогиСОбработками()
...
Процедура ОбработатьКаталогОбработки(Знач КаталогОбработки)
...
Функция ОбработатьФайлОбработки(Знач Файл, Знач КаталогОбработки)
